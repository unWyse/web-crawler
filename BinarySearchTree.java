...
///////////////////////////////////////NEW METHODS///////////////////////////////////////
  ...
  private BSTNode<T> recAddUnique(T element, BSTNode<T> tree)
  // Adds element to tree; tree retains its BST property.
  {
    added = false;
    if (tree == null){
      ...
      tree.setLeft(recAddUnique(element, tree.getLeft()));    // Add in left subtree
      added = true;
    }
    else if (element.compareTo(tree.getInfo()) > 0){
      tree.setRight(recAddUnique(element, tree.getRight()));   // Add in right subtree
      added = true;
    }
    return tree;
  }
  ...
  // Adds element to this BST. The tree retains its BST property.
  {
    root = recAddUnique(element, root);
    return added;
  }
